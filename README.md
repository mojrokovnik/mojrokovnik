...
To install application, you need to have server running, clone application and run `npm install`


### Prerequisites

You need to have `mojrokovnik-server` succesfully configured.
